...
public class SociosControllerTest {
    ...
    public void testFindById() {
        Integer id = 1;
        SociosDto sociosDto = createSociosDto(1, "Socio1", "socio1@example.com", "123456789", "Licencia1", "ID1",
                "Verificado",
    ...
    public void testCreateSocios() {
        ...
        //objetos Socio 
        List<Socios> sociosList = List.of(
                createSocios(1, "Socio1", "socio1@example.com", "123456789", "Licencia1", "ID1", "Verificado",
                        new Date(), null, null, null, true, "correo1@example.com", 1, "contrasena1"));

        when(sociosServices.createSocios(any(Socios.class), eq(1))).thenReturn(sociosList.get(0));
    ...
    public void testFindAll() {
        ...
        List<Socios> sociosList = List.of(
                createSocios(1, "Socio1", "socio1@example.com", "123456789", "Licencia1", "ID1", "Verificado",
                        new Date(), null, null, null, true, "correo1@example.com", 1, "contrasena1"),
                createSocios(2, "Socio2", "socio2@example.com", "987654321", "Licencia2", "ID2", "No verificado",
                        new Date(), null, null, null, false, "correo2@example.com", 2, "contrasena2"));
